...
previous_root=root.parent/'exp013'
previous_manifest=previous_root/'PACKET_MANIFEST.json'
if sha(previous_manifest)!='df35b6a73cff1a715d1e7e085152178571913ab453b3fd078e6f9f780c949afa':
    raise RuntimeError('Frozen Experiment 013 manifest changed')
...
checks.append(('exp013_final_packet',previous_root,previous_manifest,'json',313,
    'df35b6a73cff1a715d1e7e085152178571913ab453b3fd078e6f9f780c949afa'))
