...
spec=importlib.util.spec_from_file_location('exp014_final_source_generator',root/'make_combined.py')
generator=importlib.util.module_from_spec(spec);spec.loader.exec_module(generator)
rebuilt,reconstructed=generator.build(root)
if reconstructed!=inputs or rebuilt!=(root/'lean/Exp014Combined.lean').read_text():
...
paths=set(inputs['source_hashes'])|{'lean/Exp014Combined.lean','evidence/FINAL_INPUTS.json',
...
request={'archive':'/content/exp014_check/'+destination.name,'sha256':sha(destination),
