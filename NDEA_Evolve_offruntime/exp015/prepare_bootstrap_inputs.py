...
spec = importlib.util.spec_from_file_location('exp015_bootstrap_generator', root/'make_combined.py')
generator = importlib.util.module_from_spec(spec)
spec.loader.exec_module(generator)
combined, regenerated = generator.build(root)
require(regenerated == inputs and combined == (root/'lean/Exp015Combined.lean').read_text(),
...
record = {'archive': str(archive), 'archive_sha256': archive_hash,
          ...
          'qualification': 'Exact final-source dependency roots and pinned helpers for a fresh Experiment 015 CPU VM. No network call or compiled project artifact in this preparation.'}
