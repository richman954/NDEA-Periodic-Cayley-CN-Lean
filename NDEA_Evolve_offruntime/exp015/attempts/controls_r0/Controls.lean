...
theorem linearField_residual (t x : ℝ) :
  ...
  simp [pdeResidual, controls_linear_time_derivative, controls_linear_slice]
...
theorem linearField_l2 (t b : ℝ) : spatialL2 (linearField t) b 1 = |t| := by
  simpa only [linearField, Real.sqrt_one, one_mul, Complex.norm_real, Real.norm_eq_abs] using
