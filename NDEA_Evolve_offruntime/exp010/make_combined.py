...
def build(root):
    foundation=root/'lean/Exp009Foundation.lean'
    require(hashlib.sha256(foundation.read_bytes()).hexdigest()=='8cbf781d91f3cd0cc5f6669586c55a4c4613d6f3e9f322e10fbafff39991e8c8','Frozen foundation pin mismatch')
    modules=['Regularity','ClassicalSolution','Continuity','ClassicalClosure','Controls']
    embedded=['Exp009Foundation','InfiniteReference','WeightedTail','CutoffSchedule',
    ...
    spec=importlib.util.spec_from_file_location('exp010_catalog_policy',checker)
...
if __name__=='__main__':
    ...
    out=root/'lean/Exp010Combined.lean';out.write_text(combined)
