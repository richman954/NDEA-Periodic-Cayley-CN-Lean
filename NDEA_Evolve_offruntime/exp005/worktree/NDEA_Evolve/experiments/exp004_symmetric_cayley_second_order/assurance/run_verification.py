...
class Runner:
    ...
    def combined(self, controls: bool) -> None:
        ...
        target = self.exp / "evidence/generated" / f"CombinedExp004{'Controls' if controls else 'Production'}_{self.run_id}.lean"
...
def main() -> None:
    ...
    parser.add_argument("--cache-root", type=Path, default=Path("/tmp/exp004_build"))
