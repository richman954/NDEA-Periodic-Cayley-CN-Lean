...
- Julia: `1.12.6`, official Linux x86_64 archive SHA-256
  `bbabf3bef19421a9dbd24a767d807606ab85e444323b5a1c73ffe293fa3d079a`;
  the downloaded archive matched the official checksum before use.
- Python: `3.11.2`.
- Git: `2.39.5`.
- Toolchain library:
...
- RAM verification root: `/dev/shm/exp003_step3_shadow`.
...
per Lean invocation and a 3600-second outer bound. The combined run used a
900-second Lean bound and a 1500-second outer bound. Only one Lean/Lake job was
active at a time.

The Julia run had a 600-second timeout; the Python run had a 180-second
timeout. No package, toolchain, `lakefile.toml`, `lake-manifest.json`, or
