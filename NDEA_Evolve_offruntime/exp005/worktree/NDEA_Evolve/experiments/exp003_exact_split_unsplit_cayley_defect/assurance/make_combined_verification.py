#!/usr/bin/env python3
"""Generate a transient one-process Experiment 003 Step-3 Lean source."""
...
def main() -> None:
    ...
    step3 = args.repo / "experiments/exp003_exact_split_unsplit_cayley_defect"
    ...
    sources = [
        ...
        (step3 / "controls/lean/NegativeControls.lean", False),
    ]
