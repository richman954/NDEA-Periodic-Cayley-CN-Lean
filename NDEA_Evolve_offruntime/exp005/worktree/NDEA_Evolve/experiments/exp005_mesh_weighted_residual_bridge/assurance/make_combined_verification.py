#!/usr/bin/env python3
"""Generate one-process Experiment 005 verification from the recorded source files."""
...
def source_groups(repo: Path) -> tuple[list[Path], list[Path]]:
    ...
    predecessor = [
        ...
        repo / "NDEAEvolve/Experiments/Exp004/SymmetricCayleyLocal.lean",
        repo / "NDEAEvolve/Experiments/Exp004/SymmetricCayleyGlobal.lean",
    ]
    production = [
        repo / "NDEAEvolve/Experiments/Exp005/MeshWeightedStability.lean",
        repo / "NDEAEvolve/Experiments/Exp005/SymmetricStageResidual.lean",
        repo / "NDEAEvolve/Experiments/Exp005/MeshFamilyConvergence.lean",
    ]
