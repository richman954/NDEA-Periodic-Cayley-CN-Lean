...
name, receipt = sys.argv[1], Path(sys.argv[2]).resolve()
counts = {'InitialErrorTransfer': 8, 'BaselineTimeOneConvergence': 3, 'FiniteHorizonSchedule': 8,
    'FiniteHorizonSpatial': 4, 'FiniteHorizonCertificate': 3, 'UniformGridTimeConvergence': 8}
