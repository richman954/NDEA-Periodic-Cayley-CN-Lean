...
with explicit potential-perturbation estimates. InitializationCertificate now replaces the initial term by its proved sampling tail and arbitrary physical-grid mismatch; the actual sampled initial norm is uniformly bounded.
