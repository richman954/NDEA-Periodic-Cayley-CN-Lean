...
spec=importlib.util.spec_from_file_location('exp011_final_source_generator',root/'make_combined.py')
generator=importlib.util.module_from_spec(spec);spec.loader.exec_module(generator)
rebuilt,reconstructed=generator.build(root)
if reconstructed!=inputs or rebuilt!=(root/'lean/Exp011Combined.lean').read_text():
...
paths=set(inputs['source_hashes'])|{'lean/Exp011Combined.lean','evidence/FINAL_INPUTS.json',
...
request={'archive':'/content/exp011_check/'+destination.name,'sha256':sha(destination),
