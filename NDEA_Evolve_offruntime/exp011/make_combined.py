...
def build(root):
    foundation=root/'lean/Exp010Foundation.lean'
    require(hashlib.sha256(foundation.read_bytes()).hexdigest()=='fb7b27b42d0baaca9ab8b30f9ba80bb0a5b8999986342fe8538e880bb3947ef0','Frozen foundation pin mismatch')
    modules=['SolutionLipschitz','Reconstruction','ScheduleBounds','UniformConvergence','Controls']
    embedded=['Exp010Foundation','InfiniteReference','WeightedTail','CutoffSchedule',
    ...
    spec=importlib.util.spec_from_file_location('exp011_catalog_policy',checker)
...
if __name__=='__main__':
    ...
    out=root/'lean/Exp011Combined.lean';out.write_text(combined)
