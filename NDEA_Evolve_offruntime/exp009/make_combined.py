...
def build(root):
    foundation=root/'lean/Exp008Foundation.lean'
    require(hashlib.sha256(foundation.read_bytes()).hexdigest()=='5fbcbcb39be7d68145f1c74f7210f45f5e067cea68a43a49342cd40e040752a0','Frozen foundation pin mismatch')
    modules=['InfiniteReference','WeightedTail','CutoffSchedule','InfiniteClosure','WeightedClosure','ScheduleClosure','Controls']
    ...
    for p in files:
        ...
        for m in re.findall(r'^import (\S+)',s,re.M):
            ...
            else:require(m in modules+['Exp008Foundation','SuperpositionClosure'],'Unexpected project import: '+m)
        if p!=foundation:
            stack=[]
...
if __name__=='__main__':
    ...
    out=root/'lean/Exp009Combined.lean';out.write_text(combined)
