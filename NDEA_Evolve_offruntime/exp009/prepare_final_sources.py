...
paths=set(inputs['source_hashes'])|{'lean/Exp009Combined.lean','evidence/FINAL_INPUTS.json',
...
request={'archive':'/content/exp009_check/'+destination.name,'sha256':sha(destination),
