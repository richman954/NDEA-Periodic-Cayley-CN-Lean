...
def build(root):
    foundation=root/'lean/Exp012Foundation.lean'
    require(hashlib.sha256(foundation.read_bytes()).hexdigest()=='ff98d87926fe6729202d77119d84e3ff3b3a3664ab607c0069a52db2c9f8547d','Frozen foundation pin mismatch')
    modules=['GenericClassical','GenericEnergy','GenericUniqueness','LegacyBridge','Controls']
    embedded=['Exp012Foundation','InfiniteReference','WeightedTail','CutoffSchedule',
              ...
              'EnergyLocal','EnergyConservation','EnergySeparation','ClassicalUniqueness']
    ...
    spec=importlib.util.spec_from_file_location('exp013_catalog_policy',checker)
...
if __name__=='__main__':
    ...
    out=root/'lean/Exp013Combined.lean';out.write_text(combined)
