...
with tempfile.TemporaryDirectory(prefix='exp013_protocol_') as temp:
    ...
    environment.update(session='exp013-independent-check',boot_id='00000000-0000-4000-8000-000000000013')
    ...
    allocation={'utc':environment['utc'],'root':'/content/exp013_check','session':'exp013-independent-check',
        'vm_id':'SYNTHETIC_EXP013_FIXTURE','distinct_allocation':True,'previous_vm_ids':
        ['m-s-kkb-usw4c1-1loxz56gsupls','m-s-kkb-usw3b1-3oqo9i5fec2ow','m-s-kkb-use1c1-1e742c6fpiifs','m-s-kkb-usc1a1-d4w1b6hb9jym','m-s-kkb-usc1b1-2yftnii3g1zpd','m-s-kkb-usc1c1-1p1nzzki4492q']}
