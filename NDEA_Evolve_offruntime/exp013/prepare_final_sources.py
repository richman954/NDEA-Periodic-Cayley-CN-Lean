...
spec=importlib.util.spec_from_file_location('exp013_final_source_generator',root/'make_combined.py')
generator=importlib.util.module_from_spec(spec);spec.loader.exec_module(generator)
rebuilt,reconstructed=generator.build(root)
if reconstructed!=inputs or rebuilt!=(root/'lean/Exp013Combined.lean').read_text():
...
paths=set(inputs['source_hashes'])|{'lean/Exp013Combined.lean','evidence/FINAL_INPUTS.json',
...
request={'archive':'/content/exp013_check/'+destination.name,'sha256':sha(destination),
