...
previous_root=root.parent/'exp012'
previous_manifest=previous_root/'PACKET_MANIFEST.json'
if sha(previous_manifest)!='f672a80e505e8959e2c15aed3e4f812e97175cf3202fbf42f993137fc6f835e7':
    raise RuntimeError('Frozen Experiment 012 manifest changed')
...
checks.append(('exp012_final_packet',previous_root,previous_manifest,'json',171,
    'f672a80e505e8959e2c15aed3e4f812e97175cf3202fbf42f993137fc6f835e7'))
