...
paths=set(inputs['source_hashes'])|{'lean/Exp008Combined.lean','evidence/FINAL_INPUTS.json',
...
request={'archive':'/content/exp008_check/'+destination.name,'sha256':sha(destination),
